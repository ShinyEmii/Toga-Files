...
This directory is deprecated. Instead use this [UEViewer](https://github.com/ShinyEmii/UEViewer) fork that handles Rocket League packages.
...
List of UPK files that are currently unavailable to be analyzed.
